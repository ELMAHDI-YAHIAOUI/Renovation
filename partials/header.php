        ...
        <div class="row m04m">
            ...
            <div class="collapse navbar-collapse" id="main_nav">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item <?php echo isMenuActive('/projects.php'); ?>">
                        <a href="projects.php" class="nav-link">projets</a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" role="button" aria-expanded="false">services</a>
                        <ul class="dropdown-menu" role="menu" <?php echo isMenuActive('/services.php'); ?>>

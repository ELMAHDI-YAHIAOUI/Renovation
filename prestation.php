...
?>
    ...
    <section id="pageCover" class="row servicePage" style='background: url("images/prestation.jpg") no-repeat scroll center center;'>
        <div class="row pageTitle">Prestation</div>
                            ...
                            <div class="col-sm-12">
                                <div class="row m0 whyUsInner">
                                    <div class="col-sm-7">
                                        ...
                                        <p>Notre entreprise se consacre à fournir des services de rénovation complets, visant à offrir confort et bien-être aux ménages et aux individus. Nous prenons en charge tous les aspects du projet, de la conception à la réalisation.</p>
                                    </div>
                                    <div class="col-sm-5">
                        ...
                        <div class="row m0 whatOffer" id="prestation">
                            <div class="col-sm-12">
                                <div class="row m0 whatOfferInner">
                                    <h3>Service de Prestation</h3>
                                    <p><span class="fleft bigLetter">P</span> <span>restation</span> est conçu pour offrir une solution complète et polyvalente aux besoins de réparation et d'entretien à domicile des clients. Les prestataires de services sont des professionnels qualifiés et expérimentés dans plusieurs domaines, ce qui leur permet de répondre à une variété de demandes.
                                    L'une des principales caractéristiques du service de prestation est sa capacité à résoudre divers problèmes domestiques. Cela peut inclure la réparation de petits appareils électroménagers tels que les machines à laver, les réfrigérateurs, les fours, les aspirateurs, les cafetières, etc. Les techniciens sont compétents pour diagnostiquer et résoudre les pannes, en effectuant les réparations nécessaires pour rétablir le bon fonctionnement de ces appareils.
                                    </p>
                                </div>
                            </div>
                        </div>

...
?>
    ...
    <section id="pageCover" class="row servicePage" style='background: url("images/prestation.jpg") no-repeat scroll center center;'>
        <div class="row pageTitle">Plomberie de Dépannage et Installation</div>
                            ...
                            <div class="col-sm-12">
                                <div class="row m0 whyUsInner">
                                    <div class="col-sm-7">
                                        ...
                                        <p>Garantit le bon fonctionnement des systèmes sanitaires, l'approvisionnement en eau et le drainage. Des experts en plomberie sont disponibles pour résoudre les problèmes de plomberie, installer de nouveaux équipements sanitaires et améliorer l'efficacité énergétique de vos installations.</p>
                                    </div>
                                    <div class="col-sm-5">
                        ...
                        <div class="row m0 whatOffer" id="prestation">
                            <div class="col-sm-12">
                                <div class="row m0 whatOfferInner">
                                    <h3>Service de plomberie de dépannage et installation</h3>
                                    <p><span class="fleft bigLetter">P</span> <span>lomberie de dépannage et installation</span> 
                                    Ce service se concentre sur les problèmes de plomberie courants, tels que les fuites d'eau, les tuyaux obstrués, les problèmes de robinetterie, les toilettes qui fuient, les installations de plomberie pour les nouvelles constructions, etc. Les plombiers de dépannage et d'installation sont des professionnels
                                     qualifiés dans la manipulation des systèmes de plomberie résidentiels et commerciaux. Ils sont compétents pour diagnostiquer les problèmes de plomberie,
                                     réparer ou remplacer les tuyaux défectueux, les robinets, les joints d'étanchéité, les vannes, les pompes et les chauffe-eau. Ils peuvent également effectuer des installations de plomberie complètes, y compris l'installation de systèmes de tuyauterie, de lavabos, de douches, de baignoires et de toilettes.
                                 </p>
                                </div>
                            </div>
                        </div>
